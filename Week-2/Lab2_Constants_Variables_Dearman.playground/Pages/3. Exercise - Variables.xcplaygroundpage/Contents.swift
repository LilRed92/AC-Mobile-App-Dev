...
print("Yes the code compiles. It does so because we defined schooling as a variable, not a constant. This, therefore, allows us to update schooling as needed without issues.")
